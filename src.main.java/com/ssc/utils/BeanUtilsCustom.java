...
public class BeanUtilsCustom extends BeanUtils{
	...
	public static void copyPropertiesCustom(Object source, Object target) throws BeansException {
		copyPropertiesCustom(source, target,null,(String[]) null);
	}
	
	public static void copyPropertiesCustom(Object source, Object target, Class<?> editable) throws BeansException {
		copyPropertiesCustom(source, target, editable, (String[]) null);
	}
	
	public static void copyPropertiesCustom(Object source, Object target, String... selectedProperties) throws BeansException {
		copyPropertiesCustom(source, target,null,selectedProperties);
	}
...
//		copyPropertiesCustom(source, target, editable,ignoreProperties);
//	}
//	
...
//	}
	...
	private static void copyPropertiesCustom(Object source, Object target, @Nullable Class<?> editable, @Nullable String... selectedProperties) throws BeansException {
		...
		List<String> selectedPropertiesList = (selectedProperties != null ? Arrays.asList(selectedProperties) : null);
		for (PropertyDescriptor targetPd : targetPds) {
			Method writeMethod = targetPd.getWriteMethod();
			if (writeMethod != null && (selectedPropertiesList == null || selectedPropertiesList.contains(targetPd.getName()))) {
