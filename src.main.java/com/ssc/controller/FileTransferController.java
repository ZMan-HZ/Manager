...
//		BeanUtilsCustom1.copyPropertiesCustom(statusBean, statusBeanCustom);
...
//		Path parentPaht = Paths .get(projectAttachmentBeanCustomList.get(0).getFilePath()).getParent();
		...
		Path parentPaht = Paths .get(projectAttachmentBeanCustomList.get(0).getFilePath()).getParent();
		deleteEmptyFolder(parentPaht);
		deleteEmptyFolder(parentPaht.getParent());
	 ...
	 * @param parentPaht
	 */
	public void deleteEmptyFolder(Path parentPaht) {
