...
public class ReleaseNoteController {
	...
	public ModelAndView releaseNote(Integer[] checkbox_id,String statusFlag,String statusToFlag) throws Exception{
		...
		List<StatusBeanCustom> statusBeanCutomList = statusService.getStatusByIDList(statusBeanVo);
...
//					statusBeanCustom.setItemDescwithoutChangeType(statusBeanCustom.getItemDesc().substring(0, statusBeanCustom.getItemDesc().indexOf("[")));
